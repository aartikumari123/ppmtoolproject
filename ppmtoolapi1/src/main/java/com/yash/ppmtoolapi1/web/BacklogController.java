...
public class BacklogController {
	...
	@GetMapping("/{project_Identifier}/{pt_id}")
	public ResponseEntity<?> getByProjectTask(@PathVariable String project_Identifier, @PathVariable String pt_id)
	{
		ProjectTask projectTask=projectTaskService.findByProjectSequence(pt_id);
